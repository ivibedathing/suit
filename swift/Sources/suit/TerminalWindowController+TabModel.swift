...
// The tab-model core split out of TerminalWindowController.swift: strip wiring,
// pane-focus tracking, and the browser-style activate/display/new-tab helpers.
// Stored properties (lastFocusedPane, firstResponderObservation) stay in the
// main file — Swift forbids stored properties in extensions.
